...
export declare namespace EmmetZealyAirdrop {
  export type PositionStruct = { locked: BigNumberish; unlocked: BigNumberish };

  export type PositionStructOutput = [locked: bigint, unlocked: bigint] & {
    locked: bigint;
    unlocked: bigint;
  };
}
...
export interface EmmetZealyAirdropInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "addPositions",
    values: [AddressLike[], EmmetZealyAirdrop.PositionStruct[]]
  ): string;
...
export namespace LockedEvent {
  export type InputTuple = [block: BigNumberish, timestamp: BigNumberish];
  export type OutputTuple = [block: bigint, timestamp: bigint];
  export interface OutputObject {
    block: bigint;
    timestamp: bigint;
  }
...
export namespace UnclaimedWithdrawnEvent {
...
export interface EmmetZealyAirdrop extends BaseContract {
  ...
  addPosition: TypedContractMethod<
    [user: AddressLike, locked_: BigNumberish, unlocked_: BigNumberish],
    [void],
    "nonpayable"
  >;

  addPositions: TypedContractMethod<
    [users: AddressLike[], positions_: EmmetZealyAirdrop.PositionStruct[]],
    [void],
    "nonpayable"
  >;
  ...
  positions: TypedContractMethod<
    [arg0: AddressLike],
    [[bigint, bigint] & { locked: bigint; unlocked: bigint }],
    "view"
  >;
  ...
  >;
  getEvent(
    key: "UnclaimedWithdrawn"
  ): TypedContractEvent<
    UnclaimedWithdrawnEvent.InputTuple,
    UnclaimedWithdrawnEvent.OutputTuple,
    UnclaimedWithdrawnEvent.OutputObject
  >;
  getEvent(
    key: "Unlocked"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "Locked(uint256,uint256)": TypedContractEvent<
      LockedEvent.InputTuple,
      LockedEvent.OutputTuple,
      LockedEvent.OutputObject
    >;
    ...
    "UnclaimedWithdrawn(uint256)": TypedContractEvent<
      UnclaimedWithdrawnEvent.InputTuple,
      UnclaimedWithdrawnEvent.OutputTuple,
      UnclaimedWithdrawnEvent.OutputObject
    >;
    UnclaimedWithdrawn: TypedContractEvent<
      UnclaimedWithdrawnEvent.InputTuple,
      UnclaimedWithdrawnEvent.OutputTuple,
      UnclaimedWithdrawnEvent.OutputObject
    >;

    "Unlocked(uint256,uint256)": TypedContractEvent<
      UnlockedEvent.InputTuple,
      UnlockedEvent.OutputTuple,
      UnlockedEvent.OutputObject
    >;
