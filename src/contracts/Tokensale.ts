...
export interface TokensaleInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "addPriceRange",
  ...
  encodeFunctionData(
    functionFragment: "computeRefKey",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "createReference",
    values: [string]
  ): string;
  encodeFunctionData(functionFragment: "decimals", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "discountGroups",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updatePriceRange",
...
export namespace CashWithdrawnEvent {
...
export namespace ReferenceCreatedEvent {
  export type InputTuple = [owner: AddressLike, ref: string];
  export type OutputTuple = [owner: string, ref: string];
  export interface OutputObject {
    owner: string;
    ref: string;
  }
...
export namespace TokensPurchasedEvent {
  ...
  export type OutputTuple = [buyer: string, released: bigint, locked: bigint];
  export interface OutputObject {
    buyer: string;
    released: bigint;
    locked: bigint;
...
export interface Tokensale extends BaseContract {
  ...
  addPriceRange: TypedContractMethod<
    [min: BigNumberish, max: BigNumberish, price: BigNumberish],
    [void],
    "nonpayable"
  >;

  buy: TypedContractMethod<
    [pay: BigNumberish, ref: string],
    [void],
    "nonpayable"
  >;
  ...
  discounts: TypedContractMethod<
    [arg0: BigNumberish],
    [[bigint, bigint, bigint] & { min: bigint; max: bigint; price: bigint }],
    "view"
  >;
  ...
  updateRewards: TypedContractMethod<
    [_rewards1: BigNumberish, _rewards2: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "computeRefKey"
  ): TypedContractMethod<[ref: string], [string], "view">;
  getFunction(
    nameOrSignature: "createReference"
  ): TypedContractMethod<[ref: string], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "discountGroups"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "discounts"
  ): TypedContractMethod<
    [arg0: BigNumberish],
    [[bigint, bigint, bigint] & { min: bigint; max: bigint; price: bigint }],
    "view"
  >;
  getFunction(
    nameOrSignature: "estimate"
  ): TypedContractMethod<[pay: BigNumberish], [bigint], "view">;
  getFunction(
    nameOrSignature: "getRefOwner"
  ): TypedContractMethod<[ref: string], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "rewards1"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "rewards2"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "updatePriceRange"
  ): TypedContractMethod<
    [
      min: BigNumberish,
      max: BigNumberish,
  ...
  getEvent(
    ...
    CashWithdrawnEvent.InputTuple,
    CashWithdrawnEvent.OutputTuple,
    CashWithdrawnEvent.OutputObject
  >;
  getEvent(
    key: "Initialized"
  ): TypedContractEvent<
  ...
  >;
  getEvent(
    key: "ReferenceCreated"
  ): TypedContractEvent<
    ReferenceCreatedEvent.InputTuple,
    ReferenceCreatedEvent.OutputTuple,
    ReferenceCreatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "CashWithdrawn(uint256)": TypedContractEvent<
      CashWithdrawnEvent.InputTuple,
      CashWithdrawnEvent.OutputTuple,
      CashWithdrawnEvent.OutputObject
    >;
    CashWithdrawn: TypedContractEvent<
      CashWithdrawnEvent.InputTuple,
      CashWithdrawnEvent.OutputTuple,
      CashWithdrawnEvent.OutputObject
    >;
    ...
    "ReferenceCreated(address,string)": TypedContractEvent<
      ReferenceCreatedEvent.InputTuple,
      ReferenceCreatedEvent.OutputTuple,
      ReferenceCreatedEvent.OutputObject
    >;
    ReferenceCreated: TypedContractEvent<
      ReferenceCreatedEvent.InputTuple,
      ReferenceCreatedEvent.OutputTuple,
      ReferenceCreatedEvent.OutputObject
    >;
    ...
    "TokensWithdrawn(uint256)": TypedContractEvent<
      TokensWithdrawnEvent.InputTuple,
      TokensWithdrawnEvent.OutputTuple,
      TokensWithdrawnEvent.OutputObject
    >;
