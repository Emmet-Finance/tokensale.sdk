...
export interface StakingInterface extends Interface {
    getFunction(nameOrSignature: "CFO_ROLE" | "DEFAULT_ADMIN_ROLE" | "HALF" | "MANAGER_ROLE" | "QUARTER" | "QUARTERS3" | "UPGRADE_INTERFACE_VERSION" | "YEAR" | "_admin_init" | "cfo" | "coinWithdraw" | "decimals" | "emmet" | "getRoleAdmin" | "grantRole" | "hasRole" | "initialize" | "manager" | "metrics" | "pause" | "paused" | "posCount" | "positions" | "positionsAndRewards" | "proxiableUUID" | "renounceRole" | "revokeRole" | "stake" | "supportsInterface" | "terms" | "token" | "unpause" | "unstake" | "updateCFO" | "updateEmmet" | "updateManager" | "updateTerms" | "upgradeToAndCall" | "withdrawExcess" | "withdrawRewards"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Initialized" | "Paused" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "RoleUdated" | "Staked" | "TermsUpdated" | "Unpaused" | "Unstaked" | "UpdatesMinEmmetAmount" | "Upgraded" | "Withdraw" | "WithdrawnRewards"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "initialize", values: [AddressLike, AddressLike, AddressLike, AddressLike, boolean]): string;
